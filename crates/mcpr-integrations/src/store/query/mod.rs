...
mod tests {
    ...
    pub(crate) fn seeded_engine() -> QueryEngine {
        ...
        // Seed requests
        let requests = vec![
            ("r1", 1000i64, "api", Some("s1"), "tools/call", Some("search"), 142i64, "ok", None::<&str>, None::<&str>, Some(256i64), Some(1024i64)),
            ("r2", 2000, "api", Some("s1"), "tools/call", Some("search"), 891, "ok", None, None, Some(256), Some(4096)),
            ("r3", 3000, "api", Some("s1"), "tools/call", Some("create_order"), 4201, "error", Some("-32600"), Some("timeout"), Some(512), None),
            ("r4", 4000, "api", Some("s2"), "resources/read", None, 23, "ok", None, None, Some(64), Some(2048)),
            ("r5", 5000, "api", Some("s2"), "tools/call", Some("search"), 156, "ok", None, None, Some(256), Some(1024)),
        ];

        for (id, ts, proxy, sid, method, tool, latency, status, err_code, err_msg, bytes_in, bytes_out) in requests {
            conn.execute(
